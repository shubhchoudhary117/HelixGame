...
var ASM_CONSTS = {
  5005324: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5005379: function($0) {performance.now = function() { return $0; };},  
 5005427: function($0) {performance.now = function() { return $0; };},  
 5005475: function() {performance.now = Module['emscripten_get_now_backup'];},  
 5005530: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5005591: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5005655: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _GetFloatValue(betNumber) {
            if (typeof window.dispatchReactUnityEvent === 'function') {
              window.dispatchReactUnityEvent('GetFloatValue',Module.myFloatValue);
            } else {
              console.error('dispatchReactUnityEvent function not defined');
            }
            return Module.myFloatValue;
          }

  function _GetGameStart() {
          if (typeof window.dispatchReactUnityEvent === 'function') {
              window.dispatchReactUnityEvent('GetGameStart', Module.gamestart);
              //console.log("Received value: ", Module.gamestart);
          } else {
              console.error('dispatchReactUnityEvent function not defined');
          }
  ...
  function _GetLoadStart() {
          if (typeof window.dispatchReactUnityEvent === 'function') {
              window.dispatchReactUnityEvent('GetLoadStart', Module.loadingstart);
              
          } else {
              console.error('dispatchReactUnityEvent function not defined');
          }
          return Module.loadingstart;
      }

  function _HelicopterBurstGet() {
          if (typeof window.dispatchReactUnityEvent === 'function') {
              window.dispatchReactUnityEvent('HelicopterBurstGet', Module.myBooleanValue);
              //console.log("Received value: ", value);
          } else {
              console.error('dispatchReactUnityEvent function not defined');
          }
          return Module.myBooleanValue;
      }

  function _HelicopterBurstSet(value) {
          Module.myBooleanValue = value; // Converts the integer value to boolean
      }
  ...
  function _SetFloatValue(value) {
            Module.myFloatValue = value;
          }

  function _SetGameStart(value) {
          Module.gamestart = value; // Converts the integer value to boolean
      }

  function _SetLoadStart(value) {
          Module.loadingstart = value; // Converts the integer value to boolean
      }
...
var asmLibraryArg = {
  ...
  "GetGameStart": _GetGameStart,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "GetLoadStart": _GetLoadStart,
  "HelicopterBurstGet": _HelicopterBurstGet,
  "HelicopterBurstSet": _HelicopterBurstSet,
  ...
  "SetGameStart": _SetGameStart,
  "SetLoadStart": _SetLoadStart,
